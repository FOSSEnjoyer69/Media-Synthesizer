#Text2Image
STABLE_DIFFUSION_TEXT2IMAGE_MODELS = ["CompVis/stable-diffusion-v1-4", "runwayml/stable-diffusion-v1-5", "SG161222/Realistic_Vision_V6.0_B1_noVAE"]
...
#Paint By Example
PAINT_BY_EXAMPLE_MODEL = "Fantasy-Studio/Paint-by-Example"

#LoRa Base Models
STABLE_DIFFUSION_LORA_BASE_MODELS = STABLE_DIFFUSION_TEXT2IMAGE_MODELS + STABLE_DIFFUSION_INPAINT_MODELS